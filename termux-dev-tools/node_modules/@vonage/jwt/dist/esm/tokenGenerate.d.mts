import { Claims } from './types/claims.mjs';
import { GeneratorOptions } from './types/generatorOptions.mjs';
import './types/acl.mjs';
 ...
 * @private
 */
declare const validateOptions: (opts?: GeneratorOptions) => Claims;
/**
 ...
 * ```
 */
declare const tokenGenerate: (applicationId: string, privateKey: string | Buffer, opts?: GeneratorOptions) => string;

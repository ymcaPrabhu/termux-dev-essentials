...
import { InputAction } from '../../types/NCCO/InputAction.mjs';
import { DTMFSettings } from '../../types/NCCO/DTMFSettings.mjs';
import { SpeechSettings } from '../../types/NCCO/SpeechSettings.mjs';
 ...
 */
declare class Input implements Pick<InputAction, 'action' | 'type' | 'dtmf' | 'speech' | 'eventUrl' | 'eventMethod' | 'mode'>, Serializable {
    /**

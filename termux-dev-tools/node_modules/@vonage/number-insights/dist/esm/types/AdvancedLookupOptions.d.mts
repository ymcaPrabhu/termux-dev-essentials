import { StandardLookupOptions } from './StandardLookupOptions.mjs';
import './BasicLookupOptions.mjs';

/**
 * Interface representing advanced lookup options for a phone number lookup operation.
 */
type AdvancedLookupOptions = StandardLookupOptions & {
    /**
...
export type { AdvancedLookupOptions };

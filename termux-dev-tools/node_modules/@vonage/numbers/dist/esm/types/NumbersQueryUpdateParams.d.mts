import { MessagesCallbackTypeEnum } from '../enums/MessagesCallbackTypeEnum.mjs';
import { VoiceCallbackTypeEnum } from '../enums/VoiceCallbackTypeEnum.mjs';
import { Country } from './Country.mjs';

/**
 * Represents parameters for updating phone number settings.
 */
type NumbersQueryUpdateParams = {
    /**

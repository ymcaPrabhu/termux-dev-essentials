...
var apiUserToUser = (apiUser) => {
  ...
  const user = import_server_client.Client.transformers.camelCaseObjectKeys(
    apiUser,
    true
  );
  if (user.properties) {
...
var userToAPI = (user) => {
  const apiUser = import_server_client.Client.transformers.snakeCaseObjectKeys(
    user,
    true
  );
...
var Users = class extends import_server_client.Client {

import { VerifyLocale } from '../../enums/verifyLocale.mjs';
import { EmailWorkflow } from '../workflows/emailWorkflow.mjs';
import { SMSWorkflow } from '../workflows/smsWorkflow.mjs';
import { SilentAuthWorkflow } from '../workflows/silentAuthWorkflow.mjs';
import { VoiceWorkflow } from '../workflows/voiceWorkflow.mjs';
import { WhatsAppInteractiveWorkflow } from '../workflows/whatsAppInteractiveWorkflow.mjs';
import { WhatsAppWorkflow } from '../workflows/whatsAppWorkflow.mjs';
...
type SilentAuthWorkflowRequest = {
    redirect_url: string;
...
export type { SMSWorkflowRequest, SilentAuthWorkflowRequest, VerificationRequest };
